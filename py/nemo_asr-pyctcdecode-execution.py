...
def main(base_path):
    ...
    conformer_ctc_mdl = nemo_asr.models.EncDecCTCModelBPE.from_pretrained(model_name="stt_en_conformer_ctc_large")
    ...
    pyctc_decodeAndComputeWER(valid_file, conformer_ctc_mdl, outputFileName)  

  
    outputFileName = "conformer_ctc_validation_results.txt"
    decodeAndComputeWER(valid_file, conformer_ctc_mdl, outputFileName)  
