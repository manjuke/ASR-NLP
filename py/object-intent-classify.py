...
def readInputFile(csv_file):
    ...
    object_category = data['object'].str.lower().str.replace(" ", "_")  # convert to lower case then replace spaces by _
    return list(transcript.str.lower()), list(object_category) #Convert to list type & return
...
def main(base_path):
    ...
    print("Unique object labels in training data: ", set(labels_train), "count ", len(set(labels_train)))
    print("Unique object labels in validataion data: ", set(labels_valid), "count ", len(set(labels_valid)))
