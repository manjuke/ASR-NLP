...
def readInputFile(csv_file):
    ...
    location = data['location'].str.lower().str.replace(" ", "_")  # convert to lower case then replace spaces by _
    return list(transcript.str.lower()), list(location) #Convert to list type & return
...
def main(base_path):
    ...
    print("Unique location labels in training data: ", set(labels_train), "count ", len(set(labels_train)))
    print("Unique location labels in validataion data: ", set(labels_valid), "count ", len(set(labels_valid)))
    ...
    print("Training SVM for Intent classification i.e predicting location using transcription")
